...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Oficina</a></li>
    ...
    <div class="row">
        <div class="col-xs-11">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Actualización de la Oficina<br>
                Los campos con (<strong>*</strong>) son obligatorios</div>

                <div class="panel-body">
                   {!! Form::open(['route' => ['oficinas.update',$oficina->id], 'method' => 'put']) !!}
    
                         @include('admin.oficinas.partials.edit-fields')
