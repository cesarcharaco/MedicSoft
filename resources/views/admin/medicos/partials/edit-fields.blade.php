...
<div class="form-group{{ $errors->has('direccion') ? ' has-error' : '' }}">
	...
	{!! Form::textarea('direccion', $medico->direccion, ['class' => 'textarea','required' => 'required', 'placeholder' => 'Ej: Calle Manhattan, casa nro. 4', 'title' => 'Ingrese la dirección del paciente', 'onkeyup' => 'javascript:this.value=this.value.toUpperCase()','cols' => '100', 'style'=>$errors->has('direccion') ? 'border-color: red; border: 1px solid red;': '']) !!}
</div>