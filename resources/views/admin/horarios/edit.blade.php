    ...
    <div class="row">
        <div class="col-xs-11">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Actualización de Horario de la Especialidad<br>
                Los campos con (<strong>*</strong>) son obligatorios</div>

                <div class="panel-body">
                   {!! Form::open(['route' => ['horarios.update',$id_especialidad], 'method' => 'put']) !!}
    
                         @include('admin.horarios.partials.edit-fields')
